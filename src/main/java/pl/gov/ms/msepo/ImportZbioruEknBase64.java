 ...
 *         &lt;element name="base64xml" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ImportZbioruEknBase64")
public class ImportZbioruEknBase64 {
    ...
    @XmlElementRef(name = "base64xml", namespace = "http://ms.gov.pl/msepo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> base64Xml;
     ...
     *     
     */
    public JAXBElement<String> getBase64Xml() {
        return base64Xml;
    }
     ...
     *     
     */
    public void setBase64Xml(JAXBElement<String> value) {
