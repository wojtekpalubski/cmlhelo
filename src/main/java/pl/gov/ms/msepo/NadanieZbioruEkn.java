...
@XmlRootElement(name = "NadanieZbioruEkn")
public class NadanieZbioruEkn {
    ...
    @XmlElementRef(name = "xml", namespace = "http://ms.gov.pl/msepo", type = JAXBElement.class, required = false)
