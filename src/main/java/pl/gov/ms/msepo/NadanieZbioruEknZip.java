 ...
 *         &lt;element name="zipFile" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "NadanieZbioruEknZip")
public class NadanieZbioruEknZip {
    ...
    @XmlElementRef(name = "zipFile", namespace = "http://ms.gov.pl/msepo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> zipFile;
     ...
     *     
     */
    public JAXBElement<String> getZipFile() {
        return zipFile;
    }
     ...
     *     
     */
    public void setZipFile(JAXBElement<String> value) {
        this.zipFile = value;
    }
