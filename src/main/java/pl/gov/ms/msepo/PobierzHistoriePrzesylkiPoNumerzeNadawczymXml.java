...
@XmlRootElement(name = "PobierzHistoriePrzesylkiPoNumerzeNadawczymXml")
public class PobierzHistoriePrzesylkiPoNumerzeNadawczymXml {
    ...
    @XmlElementRef(name = "numerNadawczy", namespace = "http://ms.gov.pl/msepo", type = JAXBElement.class, required = false)
