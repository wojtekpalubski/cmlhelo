 ...
 *         &lt;element name="maska" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PobierzKodyPocztowe")
public class PobierzKodyPocztowe {
    ...
    @XmlElementRef(name = "dataOd", namespace = "http://ms.gov.pl/msepo", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dataOd;
    ...
    @XmlElementRef(name = "maska", namespace = "http://ms.gov.pl/msepo", type = JAXBElement.class, required = false)
    protected JAXBElement<String> maska;
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getDataOd() {
        return dataOd;
    }
     ...
     *     
     */
    public void setDataOd(JAXBElement<XMLGregorianCalendar> value) {
        this.dataOd = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getMaska() {
        return maska;
    }

    /**
     * Sets the value of the maska property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setMaska(JAXBElement<String> value) {
        this.maska = value;
    }
