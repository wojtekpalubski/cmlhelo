 ...
 *         &lt;element name="guidPrzesylki" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfguid" minOccurs="0"/&gt;
 *         &lt;element name="distinct" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PobierzStatusyPrzesylekPoGuidachShort")
public class PobierzStatusyPrzesylekPoGuidachShort {
    ...
    @XmlElementRef(name = "guidPrzesylki", namespace = "http://ms.gov.pl/msepo", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfguid> guidPrzesylki;
     ...
     *     
     */
    public JAXBElement<ArrayOfguid> getGuidPrzesylki() {
     ...
     *     
     */
    public void setGuidPrzesylki(JAXBElement<ArrayOfguid> value) {
     ...
     *     
     */
    public void setDistinct(Integer value) {
        this.distinct = value;
    }
